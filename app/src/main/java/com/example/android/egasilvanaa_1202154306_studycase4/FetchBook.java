 ...
 */
public class FetchBook extends AsyncTask<String,Void,Bitmap> {
    ...
    public FetchBook(TextView titleText, ImageView authorText, EditText bookInput) {
    ...
    protected Bitmap doInBackground(String... params) {
        ...
        try {
            ...
            final String BOOK_BASE_URL =  "https://www.google.com";
